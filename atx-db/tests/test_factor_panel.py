...
from atx_db.factor_panel import (
...
from atx_db.lake import DEFAULT_EXPORT_OBJECTS, validate_lake_export
...
def test_panel_read_paths_open_read_only(tmp_store, tmp_path, monkeypatch) -> None:
    ...
    from atx_db import factor_panel as factor_panel_module
