...
def _patch(monkeypatch):
    monkeypatch.setattr("atx_db.fundamentals.sec_session", lambda ua: _FakeSession())
    monkeypatch.setattr("atx_db.fundamentals.resolve_companyfacts_targets", lambda store, opts: _TARGETS)
...
def test_ciks_from_loaded_facts_returns_loaded_universe(tmp_store):
    ...
    from atx_db.fundamentals import ciks_from_loaded_facts
...
def test_normalize_drops_non_us_gaap_taxonomies():
    ...
    from atx_db.fundamentals import normalize_companyfacts
