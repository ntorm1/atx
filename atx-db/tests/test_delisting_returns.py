...
def test_reconciliation_id_is_unique_when_two_delisting_events_share_a_security_day(tmp_store) -> None:
    ...
    from atx_db.delisting import DelistingEventOptions, reconcile_delisting_codes, refresh_delisting_events
...
def test_cash_merger_policy_terminal_return_is_deterministic(tmp_store):
    from atx_db.delisting import apply_terminal_return_policy, load_terminal_return_policy_dim
...
def test_compute_terminal_returns_union_is_futurewarning_clean(tmp_store) -> None:
    ...
    from atx_db.delisting import compute_delisting_terminal_returns, load_terminal_return_policy_dim
...
def test_forward_return_uses_stitched_dlret_when_delisting_midhorizon():
    from atx_db.delisting import compute_survivorship_safe_forward_returns
...
def test_dlret_not_visible_before_delist_confirmation(tmp_store, tmp_path):
    ...
    from atx_db.asof import delisting_return_observations_asof
    _seed_security(tmp_store)
...
def test_delisting_code_reconciliation_unresolved_fires_on_unmapped_not_mismatch(tmp_store):
    ...
    from atx_db.quality.checks_survivorship import delisting_code_reconciliation_check
    con = tmp_store.con
    con.execute(
