"""Regression: import atx_db succeeds and key Dataset classes are importable."""

from __future__ import annotations


def test_import_atx_db():
...
def test_key_dataset_classes_importable():
    ...
    assert Form144IntentDataset is not None
...
def test_migration_symbols_exported():
    from atx_db import MIGRATIONS, Migration, apply_pending_migrations
...
def test_atx_db_calendar_not_shadowing_stdlib():
    """Ensure atx_db.calendar does not shadow the stdlib calendar module."""
    import calendar as stdlib_calendar

    # stdlib calendar has isleap(); atx_db.calendar does not
