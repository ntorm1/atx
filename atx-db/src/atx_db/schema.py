...
def ensure_quant_schema(store: DuckDBStore) -> None:
    ...
    con.execute(
        ...
        CREATE TABLE IF NOT EXISTS xbrl_filing_contexts (
            ...
            filing_primary_document VARCHAR,
            instance_document VARCHAR,
            instance_format VARCHAR,
...
def _seed_catalog(store: DuckDBStore) -> None:
    ...
    source_rows = [
        (
            ...
            "SEC EDGAR APIs",
            "https://www.sec.gov/",
            "Public SEC EDGAR data; follow SEC fair access policy.",
            "daily",
            False,
        ),
        ...
        (
            ...
            "Public symbol directory files.",
            "intraday",
            False,
        ),
        (
            "tbltickerhistory",
            "tbltickerhistory local archive",
            None,
            "Local vendor/source archive in Downloads.",
            "daily",
            False,
        ),
        (
            ...
            "Public FRED graph CSV downloads; official API may require a key.",
            "varies",
            False,
        ),
        (
            ...
            "atx-db warehouse",
            None,
            "Derived internal tables, feature store, catalog, and QA metadata.",
            "on-demand",
            False,
        ),
    ]
    ...
    dataset_rows = [
        (
            ...
            "sec_edgar",
            "SEC security master",
            "Ticker, CIK, and issuer reference data.",
            "security",
            "securities",
            "as_of_date",
            "available_at",
        ...
        (
            ...
            "tbltickerhistory",
            "Daily equity bars",
            "Local daily OHLCV and vendor-derived equity fields.",
        ...
        (
            ...
            "tbltickerhistory",
            "Corporate actions",
            "Dividend and split adjustment fields where public/local source data supports them.",
        ...
        (
            ...
            "atx_warehouse",
            "Corporate-action type dimension",
            "CRSP/DTCC-style corporate-action type codes used to normalize public action evidence.",
            "type_code",
            "corp_action_type_dim",
            "updated_at",
            "updated_at",
        ...
        (
            ...
            "Event-level price/share/volume adjustment factors derived from normalized corporate actions.",
            "security_id,ex_date,event_type,source",
            "adjustment_factor_history",
            "ex_date",
            "available_at",
        ),
        (
            ...
            "Consolidated short interest by settlement date, supporting symbol-scoped loads, all-symbol date refreshes, and compact historical backfill controls.",
        ...
        (
            "finra_short_interest_backfills",
            "finra",
            "FINRA short-interest backfill manifests",
            "Audit manifests for compact all-symbol FINRA settlement-date backfill runs.",
            "manifest,settlement_date_window",
        ...
        (
            ...
            "PIT feature-store rows for short pressure, days-to-cover, short-interest changes, and cross-sectional ranks derived from FINRA consolidated short interest.",
            "security_id,feature,settlement_date",
            "feature_values",
            "as_of_date",
            "available_at",
        ),
        ...
        (
            ...
            "sec_edgar",
            "SEC 13F ownership features",
            "PIT manager master, filing report, security position, ownership aggregate, and feature-store rows derived from loaded SEC 13F data.",
            "manager,security,report_period",
        ...
        (
            ...
            "sec_edgar",
            "SEC Section 16 insider ownership",
            "Form 3/4/5 ownership XML filings normalized into insider, issuer-role, transaction, holding, and 10b5-1 trading-plan tables.",
            "insider,security,filing,transaction",
            "insider_transaction",
            "as_of_date",
            "available_at",
        ),
        (
            "sec_blockholder_ownership",
            "sec_edgar",
            "SEC Schedule 13D/G blockholder ownership",
            "Structured Schedule 13D/G XML filings normalized into blockholder filing and reporting-person beneficial-owner tables.",
            "security,filing,reporting_person",
            "blockholder_filing",
            "event_date",
            "available_at",
        ),
        (
            ...
            "sec_edgar",
            "SEC company facts",
            "XBRL company facts normalized into PIT fundamental points.",
            "security_id,concept,period",
            "fundamental_points",
            "period_end",
            "available_at",
        ),
        (
            ...
            "PIT share-count history derived from SEC XBRL shares outstanding/basic average/diluted average facts.",
        ...
        (
            ...
            "PIT daily split and total-return adjustment factors materialized from daily bars and event-level corporate actions.",
            "security_id,trade_date,as_of_date,source",
            "daily_adjustment_factors",
            "as_of_date",
            "available_at",
        ),
        (
            ...
            "sec_edgar",
            "XBRL concept catalog",
            "Concept-level SEC companyfacts metadata with observed units, forms, availability, and fact coverage.",
        ...
        (
            "xbrl_taxonomy",
            "sec_edgar",
            "XBRL taxonomy relationships",
            "FASB US GAAP and SEC Reporting Taxonomy package metadata, presentation/calculation/definition relationships, dimensional edges, and observed SEC companyfacts frames.",
            "taxonomy_package,linkbase,role,concept_relationship",
        ...
        (
            "xbrl_dimensions",
            "sec_edgar",
            "XBRL dimensional taxonomy",
            "Definition-linkbase dimensional edges for axes, domains, members, tables, and line items.",
            "taxonomy_package,role,source_concept,target_concept",
        ...
        (
            "xbrl_fact_frames",
            "sec_edgar",
            "SEC companyfacts frames",
            "Observed SEC companyfacts frame metadata by concept, unit, and calendar frame code.",
            "source,taxonomy,concept,unit,frame",
            "xbrl_fact_frames",
            "last_available_at",
            "last_available_at",
        ),
        (
            ...
            "sec_edgar",
            "SEC filing XBRL contexts",
            "Issuer filing-instance XBRL contexts and segment/scenario dimension members parsed from inline XBRL or legacy EX-101.INS XML.",
            "security_id,accession_number,instance_document,context_id",
            "xbrl_filing_contexts",
            "acceptance_datetime",
            "source_loaded_at",
        ),
        (
            ...
            "sec_edgar",
            "SEC filing XBRL dimensions",
            "Explicit and typed segment/scenario dimension members parsed from issuer inline XBRL filing contexts.",
            "security_id,accession_number,context_id,dimension,member",
            "xbrl_filing_dimensions",
            "acceptance_datetime",
            "source_loaded_at",
        ),
        (
            "xbrl_filing_facts",
            "sec_edgar",
            "SEC filing inline XBRL facts",
            "Source filing-instance inline XBRL facts linked to parsed contexts by contextRef.",
            "security_id,accession_number,primary_document,context_ref,concept",
            "xbrl_filing_facts",
            "acceptance_datetime",
            "source_loaded_at",
        ),
        (
            "xbrl_validation",
            "sec_edgar",
            "XBRL filing validation",
            "Calculation-linkbase and DQC-style filing validation results by rule, filing, context, and parent concept.",
            "validation_run_id,rule_family,accession_number,parent_concept,context",
        ...
        (
            ...
            "sec_edgar",
            "Fundamental fact revisions",
            "Accession-level SEC companyfacts revision chains with PIT ordering and value deltas.",
            "security_id,taxonomy,concept,unit,period,accession",
            "fundamental_fact_revisions",
            "filed_date",
            "available_at",
        ),
        (
            ...
            "sec_edgar",
            "Fundamental statement map",
            "Canonical statement mappings from SEC XBRL concepts into normalized income statement, balance sheet, cash-flow, per-share, share-count, and industry-template metrics.",
        ...
        (
            ...
            "sec_edgar",
            "Fundamental statement points",
            "PIT-safe normalized income, balance sheet, cash-flow, per-share, and share-count facts derived from mapped SEC companyfacts revision rows.",
            "security_id,statement,metric,period,accession",
            "fundamental_statement_points",
            "as_of_date",
            "available_at",
        ),
        (
            ...
            "sec_edgar",
            "Fundamental TTM points",
            "PIT-safe trailing-twelve-month income, cash-flow, and per-share values derived from four available quarter-like normalized statement facts, including YTD-delta quarters where needed.",
            "security_id,metric,ttm_end_date,accession",
            "fundamental_ttm_points",
            "as_of_date",
            "available_at",
        ),
        (
            "fundamental_periods",
            "sec_edgar",
            "Fundamental fiscal periods",
            "PIT-safe normalized reporting-period windows derived from SEC statement points with Compustat-style datadate/rdq/pdate/fdate/ldate fields, reported fiscal labels, calendar buckets, and revision coverage.",
            "security_id,period_start,period_end,accession",
            "fundamental_periods",
            "fdate",
            "available_at",
        ),
        (
            ...
            "PIT-safe accounting, valuation, cash-flow, margin, shareholder-yield, growth, and revision features derived from SEC companyfacts, TTM statement points, revision chains, and available market data.",
            "security_id,feature,as_of_date",
            "feature_values",
            "as_of_date",
            "available_at",
        ),
        (
            ...
            "sec_edgar",
            "SEC submissions",
            "Company filing metadata by accession.",
        ...
        (
            ...
            "NASDAQ and other-listed symbol directory snapshots.",
            "symbol,as_of_date",
            "nasdaq_symbol_directory",
            "as_of_date",
            "source_loaded_at",
        ...
        (
            ...
            "nasdaq_trader",
            "Nasdaq listing add/delete events",
            "Trading system add/delete action rows from Nasdaq Trader.",
            "symbol,effective_date,source_file_created_at",
            "nasdaq_listing_events",
            "effective_date",
            "source_loaded_at",
        ),
        (
            ...
            "atx_warehouse",
            "Listing status intervals",
            "PIT listing-status intervals derived from Nasdaq directory snapshots and add/delete event checkpoints.",
            "symbol,listing_venue_code,valid_from",
            "listing_status_intervals",
            "valid_from",
            "available_at",
        ),
        (
            "delist_code_dim",
            "atx_warehouse",
            "Delisting code dimension",
            "Public delisting proxy code dimension with explicit non-CRSP caveats and optional imputation policy metadata.",
            "delist_code",
            "delist_code_dim",
            "updated_at",
            "updated_at",
        ...
        (
            ...
            "atx_warehouse",
            "Delisting events",
            "PIT public delisting evidence derived from listing-status intervals, with nullable delisting-return proxy fields and lineage back to source events.",
            "symbol,listing_venue_code,delist_date",
            "delisting_events",
            "delist_date",
            "available_at",
        ),
        (
            ...
            "atx_warehouse",
            "Observed delisting returns",
            "Injectable observed terminal-return facts such as CRSP DSEDELIST/DLRET rows, keyed by security or vendor identifier and delisting date.",
            "security_or_vendor_id,delist_date,provider",
            "delisting_return_observations",
            "delist_date",
            "available_at",
        ),
        (
            "est_measure",
            "atx_warehouse",
            "Estimate measure dimension",
            "Canonical estimate measure codes and SEC XBRL concept mappings for actuals.",
            "measure_code",
            "est_measure",
            "source_loaded_at",
            "source_loaded_at",
        ...
        (
            "est_detail",
            "injected_estimates",
            "Detail estimate observations",
            "Injectable analyst/broker-level estimate rows from licensed or public-aggregator files with provider, vendor-ID, revision, and source-file lineage.",
            "security_or_vendor_id,measure,period_end,broker,analyst,announcement",
            "est_detail",
            "as_of_date",
            "available_at",
        ),
        (
            ...
            "Injectable IBES-style or normalized consensus snapshots with mean/median/high/low/stdev, revision counts, source-file hashes, provider identifiers, stable snapshot ids, and stale-after dates.",
            "security_or_vendor_id,measure,period_end,consensus_date",
            "est_consensus",
            "as_of_date",
            "available_at",
        ),
        (
            ...
            "sec_edgar",
            "Estimate actuals",
            "Actual reported values mapped from SEC companyfacts into estimate measure codes.",
            "security_id,measure,period_end,accession",
            "est_actual",
            "as_of_date",
            "available_at",
        ),
        (
            ...
            "atx_warehouse",
            "Estimate surprises",
            "PIT standardized unexpected earnings and actual-versus-consensus surprise metrics derived from est_actual and optional est_consensus.",
            "security_id,measure,fiscal_period",
            "est_surprise",
            "as_of_date",
            "available_at",
        ),
        (
            ...
            "Company-issued guidance from SEC 8-K Item 2.02/7.01 text extraction or licensed/injectable guidance feeds.",
        ...
        (
            "est_recommendation",
            "injected_estimates",
            "Broker recommendation and price-target observations",
            "Injectable IBES-style or normalized recommendation and 12-month price-target events with broker/analyst identifiers, rating-scale normalization, source-file hashes, and active-window fields.",
            "security_or_vendor_id,broker,analyst,event_type,rating_date",
            "est_recommendation",
            "as_of_date",
            "available_at",
        ),
        ...
        (
            ...
            "fred",
            "Macro observations",
            "Macro series observations from public FRED CSV downloads.",
        ...
        (
            ...
            "universe_id,security_id,effective_date",
            "universe_memberships",
            "as_of_date",
            "available_at",
        ),
        (
            ...
            "tbltickerhistory",
            "Equity daily features",
            "Computed alpha-ready daily feature values and feature definitions.",
            "security_id,feature,as_of_date",
            "feature_values",
            "as_of_date",
            "available_at",
        ...
        (
            ...
            "Feature build lineage, input windows, output windows, and row counts.",
            "feature_set,run_id",
            "feature_build_manifests",
        ...
        (
            ...
            "Feature-set catalog and dependency edges derived from feature definitions and source-input metadata.",
            "feature_set,feature_name,dependency",
        ...
        (
            "alpha_research",
            "atx_warehouse",
            "Alpha expression registry and backtest manifests",
            "PIT-safe alpha expression catalog, signal values, and long/short backtest summary manifests.",
            "alpha_id,security_id,as_of_date",
            "alpha_signal_values",
            "as_of_date",
            "available_at",
        ),
        (
            ...
            "sec_edgar",
            "Identifier resolution candidates",
            "Non-destructive CUSIP-to-security mapping candidates from public source evidence.",
            "source_key,target_security_id,source_period",
            "identifier_resolution_candidates",
            "as_of_date",
            "available_at",
        ),
        (
            ...
            "atx_warehouse",
            "Identifier resolution decisions",
            "Accepted, rejected, and review-pending decisions derived from identifier resolution evidence.",
            "candidate_id,decision_method",
            "identifier_resolution_decisions",
            "as_of_date",
            "available_at",
        ),
        (
            ...
            "atx_warehouse",
            "Warehouse ETL jobs",
            "ETL job definitions, run history, retry policy, and event metadata.",
            "job_name,job_run_id",
            "etl_job_runs",
            "started_at",
            "finished_at",
        ...
        (
            ...
            "Recorded SQL data quality checks and verification outcomes.",
            "dataset_id,table_name,check_name,checked_at",
            "data_quality_checks",
            "checked_at",
            "checked_at",
        ),
        (
            ...
            "atx_warehouse",
            "Lake export audit",
            "Parquet lake export run and file manifests recorded in DuckDB.",
            "export_run_id,object_name",
            "lake_export_files",
            "exported_at",
            "source_loaded_at",
        ),
        (
            ...
            "atx_warehouse",
            "Warehouse catalog",
            "Source, dataset, table, field, raw artifact, run, and watermark metadata.",
            "catalog tables",
            "dataset_catalog",
            "updated_at",
            "updated_at",
        ...
        (
            ...
            "Institutional-provider domain targets mapped to open-data substitutes and warehouse tables.",
    ...
    table_rows = [
        (
            ...
            "schema",
            "version",
            "Applied warehouse schema migrations.",
            '["version"]',
        ...
        (
            ...
            "source",
            "source_system_id",
            "Public/local data source catalog.",
            '["source_system_id"]',
            "Source metadata for audit and lineage.",
        ),
        (
            "dataset_catalog",
            "catalog",
            "dataset",
            "dataset_id",
            "Dataset catalog with PIT columns and ownership.",
            '["dataset_id"]',
            "Documents PIT and available-at columns where applicable.",
        ),
        (
            "table_catalog",
            "catalog",
            "table",
            "table_name",
            "Table and view catalog.",
            '["table_name"]',
            "Documents natural keys and PIT notes.",
        ),
        (
            "field_catalog",
            "catalog",
            ...
            "Column-level catalog populated from DuckDB metadata.",
            '["table_name","field_name"]',
            "Column semantics support as-of-safe research.",
        ),
        (
            "provider_parity_matrix",
            "catalog",
            "provider_parity",
            "provider,provider_domain",
            "Institutional provider parity matrix with open-data substitutes, limits, PIT notes, and public source URLs.",
            '["provider","provider_domain"]',
            "Research/catalog table; updated_at records seed refresh.",
        ),
        (
            "raw_source_files",
            "bronze",
            "source_artifact",
            "source_id",
            "Fetched/local source artifact registry.",
            '["source_id"]',
            "Tracks source URL, cache path, hash, byte count, and fetch status.",
        ),
        (
            "dataset_runs",
            "control",
            "dataset_run",
            "run_id",
            "Dataset loader run history.",
            '["run_id"]',
            "Every dataset load receives a run_id.",
        ),
        (
            "dataset_watermarks",
            "control",
            ...
            "Dataset high-water marks.",
            '["dataset_id","watermark_name"]',
            "Used for incremental/reload planning.",
        ),
        (
            "data_quality_checks",
            "control",
            ...
            '["check_id"]',
            "Append-only check outcomes for warehouse observability.",
        ),
        (
            "etl_job_definitions",
            "control",
            "etl_job",
            "job_name",
            "Reusable ETL job definitions.",
            '["job_name"]',
            "Definitions include params, dependencies, and retry policy.",
        ),
        (
            "etl_job_runs",
            "control",
            ...
            "ETL job run history.",
            '["job_run_id"]',
            "Links job runs to dataset run ids and records retry attempts.",
        ),
        (
            "etl_job_events",
            "control",
            "etl_event",
            "job_run_id,event_time",
            "ETL event log.",
            '["job_run_id","event_time"]',
            "Chronological job events, including retry attempts.",
        ),
        (
            "lake_export_runs",
            "audit",
            "lake_export",
            "export_run_id",
            "Lake export run audit records.",
            '["export_run_id"]',
            "One row per Parquet lake export run.",
        ),
        (
            "lake_export_files",
            "audit",
            "lake_export_file",
            "export_run_id,object_name",
            "Lake export file manifests recorded in DuckDB.",
            '["export_run_id","object_name"]',
            "Use sha256 and schema_sha256 to validate exported Parquet artifacts.",
        ),
        (
            "securities",
            "core",
            ...
            '["security_id"]',
            "Use security_id as stable warehouse key; entity_id is the current sticky corporate entity; never ticker as primary key.",
        ),
        (
        ...
        (
            ...
            "core",
            "listing",
            "security_id,ticker,valid_from",
            "PIT exchange listing and ticker history.",
            '["security_id","ticker","valid_from"]',
            "Use valid_from/valid_to and available_at for as-of joins.",
        ),
        (
            "listing_status_intervals",
            "silver",
            "listing_status",
            "symbol,listing_venue_code,valid_from",
            "PIT listing status intervals derived from Nasdaq snapshot presence and add/delete event checkpoints.",
            '["listing_status_id"]',
            "Use valid_from/valid_to plus available_at for as-of-safe survivorship joins; source/evidence fields distinguish snapshot-derived and event-derived intervals.",
        ),
        (
            "delist_code_dim",
            "dimension",
            "delist_code",
            "delist_code",
            "Public delisting proxy code dimension; CRSP DLSTCD fields remain null unless licensed or reconciled evidence supplies them.",
            '["delist_code"]',
            "Imputation fields describe optional research policy and are not applied unless loader options request it.",
        ),
        (
            "delisting_events",
            "silver",
            "delisting_event",
            "source,source_listing_status_id,delist_code",
            "PIT public delisting evidence derived from listing-status intervals, with nullable delisting return and explicit imputation flags.",
            '["delisting_event_id"]',
        ...
        (
            ...
            "silver",
            "delisting_return",
            "provider,security_or_vendor_id,delist_date",
            "Observed or licensed terminal-return observations such as CRSP DLRET/DLRETX/DLAMT/DLPRC rows.",
            '["delisting_return_observation_id"]',
            "Use available_at to model when the licensed/manual observation became available; delisting_events can link to the latest matching observation.",
        ),
        (
            "est_measure",
            "dimension",
            "estimate_measure",
            "measure_code",
            "Estimate measure dimension with canonical code labels and SEC concept mappings.",
            '["measure_code"]',
            "Seeded dimension; source_loaded_at records seed refresh.",
        ),
        (
            "est_broker",
            "dimension",
            "estimate_broker",
            "broker_id",
            "Broker/estimator dimension derived from injected detail estimate rows.",
            '["broker_id"]',
            "Provider and vendor_broker_id are vintage-scoped; do not treat raw numeric vendor IDs as globally stable identities.",
        ),
        (
            "est_broker_alias",
            "dimension",
            "estimate_broker_alias",
            "broker_id,alias_type,alias_value,valid_from",
            "Broker alias rows for vendor IDs, mask codes, and names.",
            '["broker_alias_id"]',
            "Use valid_from/valid_to and provider to handle vendor identifier reshuffles.",
        ),
        (
            "est_analyst",
            "dimension",
            "estimate_analyst",
            "analyst_id",
            "Analyst dimension derived from injected detail estimate rows.",
            '["analyst_id"]',
            "Provider and vendor_analyst_id are vintage-scoped; do not treat raw numeric vendor IDs as globally stable identities.",
        ),
        (
            "est_analyst_alias",
            "dimension",
            "estimate_analyst_alias",
            "analyst_id,alias_type,alias_value,valid_from",
            "Analyst alias rows for vendor IDs, mask codes, and names.",
            '["analyst_alias_id"]',
            "Use valid_from/valid_to and provider to handle vendor identifier reshuffles.",
        ),
        (
            ...
            "dimension",
            "estimate_period",
            "provider,measure_code,period_end,fpi",
            "Forecast-period dimension preserving IBES-style FPI, fiscal period labels, period end, and expected report date.",
            '["est_period_id"]',
            "Join on period_end, not FPI alone; FPI can be bumped around announcements.",
        ),
        (
            "est_detail",
            "silver",
            "estimate_detail",
            "security_or_vendor_id,measure_code,period_end,broker_id,analyst_id,announce_date",
            "Analyst/broker-level estimate observations from injectable files.",
            '["est_detail_id"]',
            "Use available_at for feed availability and announce/revision/stop dates for active-estimate as-of queries.",
        ),
        (
            "est_consensus",
            "silver",
            "estimate_consensus",
            "security_or_vendor_id,measure_code,period_end,consensus_date",
            "Consensus estimate snapshots from injectable provider files or adapters.",
            '["est_consensus_id"]',
            "Use available_at and consensus_date/as_of_date for PIT visibility; file loads are idempotent per source hash and as-of APIs return latest non-stale snapshots by default.",
        ),
        (
            "est_actual",
            "silver",
            "estimate_actual",
            "security_id,measure_code,fiscal_year,fiscal_period,accession_number",
            "Reported actual values mapped from SEC companyfacts.",
            '["security_id","measure_code","fiscal_year","fiscal_period","accession_number"]',
            "available_at is inherited from the source filing row and must not be restamped.",
        ),
        (
            "est_surprise",
            "gold",
            ...
            "SUE and actual-versus-consensus surprise features.",
            '["security_id","measure_code","fiscal_year","fiscal_period"]',
            "available_at is inherited from originally reported actuals to avoid restatement lookahead.",
        ),
        (
            "est_guidance",
            "silver",
            ...
            '["est_guidance_id"]',
            "Use available_at and as_of_date to model extraction/feed availability; extraction_confidence and evidence_text preserve public-data QA lineage.",
        ),
        (
            "est_recommendation",
            "silver",
            "estimate_recommendation",
            "security_or_vendor_id,broker_id,analyst_id,event_type,rating_date",
            "Broker recommendation and price-target events with canonicalized IBES-direction rating fields.",
            '["est_recommendation_id"]',
            "Use available_at plus announce/activation/revision/stop dates for as-of-safe active recommendation and price-target queries; Bloomberg-style reversed scales must be converted before mixing providers.",
        ),
        (
            "est_recommendation_summary",
            "silver",
            ...
            "Aggregate recommendation distributions and price-target summary snapshots with canonicalized IBES-direction rating means.",
        ...
        (
            ...
            "sec_ticker_map",
            "cik,ticker",
            "SEC company_tickers mapping snapshot.",
            '["cik","ticker"]',
            "SEC map is current-snapshot oriented; bridge into PIT identifier history before as-of use.",
        ),
        (
            "identifier_resolution_candidates",
            "core",
            "identifier_resolution",
            "source_dataset_id,source_key_type,source_key_value,target_security_id,source_period",
            "Auditable non-destructive identifier mapping candidates.",
            '["source_dataset_id","source_key_type","source_key_value","target_security_id","source_period"]',
            "Candidates are evidence, not automatic merges; use confidence/status before accepting.",
        ),
        (
            "identifier_resolution_decisions",
            "core",
            "identifier_resolution",
            "candidate_id,decision_method",
            "Auditable identifier mapping decisions and promotion evidence.",
            '["candidate_id","decision_method"]',
            "Accepted rows may promote PIT identifiers and source holdings; use available_at for as-of-safe consumption.",
        ),
        (
            "nasdaq_symbol_directory",
            "bronze",
            "symbol_directory",
            "directory,symbol,as_of_date",
            "Nasdaq Trader symbol directory snapshots.",
            '["directory","symbol","as_of_date"]',
            "Snapshot as_of_date and load time define availability.",
        ),
        (
            "nasdaq_listing_events",
            "bronze",
            "listing_event",
            "symbol,effective_date,source_file_created_at",
            "Nasdaq Trader trading-system add/delete rows for listing-status and survivorship evidence.",
            '["event_id"]',
            "Use effective_date for the listing action date and source_loaded_at/as_of_date for warehouse availability; repeated checkpoints are needed for full history.",
        ),
        (
            "tbltickerhistory_daily",
            "bronze",
            "price",
            "source,vendor_security_id,trading_date",
            "Raw-normalized local tbltickerhistory daily rows.",
            '["source","vendor_security_id","trading_date"]',
            "Raw local archive slice; available_at defaults to post-close.",
        ),
        (
            "equity_daily_bars",
            "silver",
            "price",
            "security_id,trade_date",
            "Canonical daily OHLCV bars.",
            '["source","security_id","trade_date"]',
            "available_at defaults to post-close.",
        ),
        (
            "corporate_actions",
            "silver",
            "corporate_action",
            "security_id,ex_date,action_type",
            "Corporate action facts when source data supports them.",
            '["source","security_id","ex_date","action_type"]',
            "Use ex_date and available_at to avoid lookahead.",
        ),
        (
            "corp_action_type_dim",
            "dimension",
            ...
            "type_code",
            "Corporate-action type-code dimension aligned to CRSP distribution buckets and DTCC CAEV labels where public mappings are available.",
            '["type_code"]',
            "Small seed dimension; source_loaded_at records last seed refresh.",
        ),
        (
            "adjustment_factor_history",
            "silver",
            "adjustment_factor",
            "security_id,ex_date,event_type,source",
            "Event-level price/share/volume adjustment factors derived from corporate_actions.",
        ...
        (
            ...
            "price_adjustment",
            "security_id,trade_date,as_of_date,source",
            "Daily split-only and total-return adjustment factors plus adjusted close derivatives.",
            '["daily_adjustment_id"]',
            "Use as_of_date and available_at to avoid applying future corporate actions.",
        ),
        (
            "shares_outstanding_history",
            "silver",
            ...
            "PIT share-count history derived from normalized SEC XBRL share-count facts.",
            '["share_history_id"]',
            "Use effective_date/as_of_date/available_at for as-of-safe market-cap and float-proxy research.",
        ),
        (
            "market_cap",
            "gold",
            "valuation",
            "source,security_id,trade_date",
            "Daily market capitalization level struck from raw daily close and the latest PIT-visible share count.",
            '["source","security_id","trade_date"]',
        ...
        (
            ...
            '["source","market_cap_source","security_id","trade_date","formula_code"]',
            "For each market-cap row, the latest fundamental period with period_end <= trade_date is selected. Each row available_at is the maximum of the market-cap leg and that formula's specific fundamental inputs.",
        ),
        (
            "sec_company_facts",
            "bronze",
            "fundamental",
            "security_id,taxonomy,concept,unit,period_start,period_end,filed_date,accession_number",
            "SEC companyfacts XBRL facts.",
            '["security_id","taxonomy","concept","unit","period_start","period_end","filed_date","accession_number"]',
            "Append/revision-aware by filing date and accession.",
        ),
        (
            "xbrl_concept_catalog",
            "catalog",
            "xbrl_concept",
            "source,taxonomy,concept",
            "Observed SEC XBRL concept metadata, units, forms, date ranges, availability ranges, and coverage counts.",
            '["source","taxonomy","concept"]',
            "Derived from loaded facts; updated_at records catalog refresh and last_available_at records latest observed filing availability.",
        ),
        (
            ...
            "taxonomy_package_id",
            "Downloaded public FASB/XBRL taxonomy package metadata and checksums.",
            '["taxonomy_package_id"]',
            "source_loaded_at records package ingestion; release_year records the taxonomy vintage.",
        ),
        (
            "xbrl_taxonomy_roles",
            "catalog",
            "xbrl_taxonomy_role",
            "taxonomy_package_id,role_uri,linkbase_type,source_file",
            "Taxonomy role usage by package, linkbase, and source file.",
            '["taxonomy_package_id","role_uri","linkbase_type","source_file"]',
            "Roles are taxonomy metadata, not issuer PIT facts.",
        ),
        (
            "xbrl_taxonomy_relationships",
            "catalog",
            "xbrl_taxonomy_relationship",
            "taxonomy_package_id,linkbase_type,role,parent_concept,child_concept",
            "Presentation, calculation, and definition arcs parsed from public FASB/XBRL taxonomy linkbases.",
            '["relationship_id"]',
            "Use release_year/source_loaded_at to select taxonomy vintage; touches_observed_concept highlights concepts loaded from SEC companyfacts.",
        ),
        (
            "xbrl_dimension_edges",
            "catalog",
            "xbrl_dimension_edge",
            "taxonomy_package_id,role,source_concept,target_concept",
            "Definition-linkbase dimensional relationships including axes, domains, members, tables, and line items.",
            '["dimension_edge_id"]',
            "context_element/closed/usable preserve XBRL dimension metadata for segment/scenario analysis.",
        ),
        (
            "xbrl_fact_frames",
            "catalog",
            "xbrl_fact_frame",
            "source,taxonomy,concept,unit,frame",
            "Observed SEC companyfacts frame codes by concept/unit with parsed calendar period metadata and availability ranges.",
            '["source","taxonomy","concept","unit","frame"]',
            "SEC companyfacts frames are aggregate period metadata; use last_available_at for PIT availability.",
        ),
        (
            "xbrl_filing_contexts",
            "bronze",
            "xbrl_filing_context",
            "security_id,accession_number,instance_document,context_id",
            "XBRL context periods and entity identifiers parsed from SEC inline XBRL or legacy EX-101.INS XML instances.",
            '["filing_context_id"]',
            "acceptance_datetime/filing_date preserve filing availability; exact instance-document lineage distinguishes primary HTML from legacy XML.",
        ),
        (
            "xbrl_filing_dimensions",
            "bronze",
            "xbrl_filing_dimension",
            "filing_context_id,dimension_qname,member_qname,typed_member_value",
            "Explicit and typed segment/scenario dimension members attached to issuer filing contexts.",
            '["filing_dimension_id"]',
            "Joined to xbrl_filing_contexts for filing-period availability and to taxonomy dimension edges for taxonomy semantics.",
        ),
        (
            "xbrl_filing_facts",
            "bronze",
            "xbrl_filing_fact",
            "security_id,accession_number,primary_document,fact_ordinal",
            "Inline XBRL facts parsed from SEC primary filing documents with qname, contextRef, unitRef, raw value, and numeric value when safely normalized.",
            '["filing_fact_id"]',
            "filing_context_id links each fact to parsed context period/dimension metadata; acceptance_datetime and source_loaded_at preserve PIT availability.",
        ),
        (
            "xbrl_validation_results",
            "silver",
            "xbrl_validation_result",
            "validation_run_id,rule_family,accession_number,parent_concept,context_ref",
            "Persisted XBRL calculation-linkbase and DQC-style validation outcomes.",
            '["validation_id"]',
            "status/severity expose filing-level validation failures; source_loaded_at records validation execution time.",
        ),
        (
            "fundamental_fact_revisions",
            "silver",
            "fundamental_revision",
            "source,security_id,taxonomy,concept,unit,period_start,period_end,accession_number",
            "Accession-level SEC companyfacts revision chains with PIT ordering, latest flags, and value deltas.",
            '["source","security_id","taxonomy","concept","unit","period_start","period_end","accession_number"]',
            "Use revision_sequence, is_latest_revision, filed_date, and available_at for as-of-safe restatement analysis.",
        ),
        (
            "fundamental_statement_map",
            "catalog",
            "fundamental_statement_map",
            "source,taxonomy,concept,industry_template",
            "Canonical statement mapping for loaded SEC XBRL concepts, including bank/insurance/REIT overlays.",
            '["source","taxonomy","concept","industry_template"]',
            "Seeded public taxonomy mapping; updated_at records mapping refresh.",
        ),
        (
            "fundamental_statement_points",
            "silver",
            "fundamental_statement",
            "source,security_id,canonical_metric,unit,period_start,period_end,accession_number",
            "Normalized statement facts derived from mapped SEC companyfacts revision chains.",
            '["source","security_id","canonical_metric","unit","period_start","period_end","accession_number"]',
            "Use as_of_date/available_at plus revision_sequence/is_latest_revision for PIT-safe statement analysis.",
        ),
        (
            "fundamental_ttm_points",
            "gold",
            "fundamental_ttm",
            "source,security_id,canonical_metric,unit,ttm_end_date,anchor_statement_point_id",
            "Trailing-twelve-month statement values from four quarter-like PIT statement inputs, with YTD-delta quarter derivations for cumulative SEC facts.",
            '["source","security_id","canonical_metric","unit","ttm_end_date","anchor_statement_point_id"]',
            "TTM rows are anchored by the filing availability timestamp of visible quarter facts; use available_at and revision_sequence for PIT-safe restatement analysis.",
        ),
        (
            "fundamental_periods",
            "silver",
            "fundamental_period",
            "source,security_id,period_start,period_end,accession_number",
            "Normalized fiscal/reporting-period windows derived from statement facts.",
            '["source","security_id","period_start","period_end","accession_number"]',
            "Use datadate/rdq/pdate/fdate/ldate plus available_at/revision_sequence for PIT-safe period alignment; rdq/pdate come from matching 8-K Item 2.02 filings when present.",
        ),
        (
            "fundamental_points",
            "silver",
            "fundamental",
            "security_id,metric,period_start,period_end,as_of_date",
            "PIT fundamental points from SEC XBRL facts.",
            '["security_id","metric","period_start","period_end","as_of_date","accession_number"]',
        ...
        (
            ...
            '["security_id","accession_number"]',
            "acceptance_datetime is the filing availability timestamp when present.",
        ),
        (
            ...
            "SEC 13F submission rows from bulk ZIP data.",
            '["accession_number","source_period"]',
            "Filing/report periods are source-provided.",
        ),
        (
            ...
            "13f_cover",
            "accession_number,source_period",
            "SEC 13F cover page rows.",
            '["accession_number","source_period"]',
            "Derived from SEC bulk structured data.",
        ),
        (
        ...
        (
            ...
            "silver",
            "13f_holding",
            "accession_number,infotable_sk,source_period",
            "SEC 13F security holdings.",
            '["accession_number","infotable_sk","source_period"]',
            "Use report and filing metadata for point-in-time availability.",
        ),
        (
            "thirteenf_managers",
            "silver",
            "13f_manager",
            "manager_id",
            "SEC 13F filing-manager master derived from cover pages and submissions.",
            '["manager_id"]',
            "Manager identity is keyed by normalized filing manager CIK; first/last filing/report fields are derived from visible source rows.",
        ),
        (
            ...
            "13f_manager_report",
            "manager_report_id",
            "SEC 13F manager filing/report-period rows joined across submission, cover page, and summary page data.",
            '["manager_report_id"]',
            "Use report_period for holdings date and available_at for as-of-safe visibility after filing.",
        ),
        (
            ...
            "13f_position",
            "position_id",
            "Security-level 13F positions with manager metadata, portfolio weights, option flags, and voting authority.",
            '["position_id"]',
            "Derived from visible 13F holdings and manager report availability; supports manager/security drill-down.",
        ),
        (
            "thirteenf_security_ownership",
            "gold",
            "13f_ownership",
            "security_id,report_period,source_period",
            "PIT security-level 13F ownership aggregates and quarter-over-quarter flow fields.",
            '["ownership_id"]',
            "Use report_period/as_of_date plus available_at for as-of-safe ownership features; rows reflect currently loaded 13F holdings coverage.",
        ),
        (
            "insider",
            "silver",
            "insider",
            "insider_id",
            "Section 16 reporting-owner person dimension derived from EDGAR ownership XML.",
            '["insider_id"]',
            "Use reporting_owner_cik when present; source_loaded_at and filing-derived dates audit identity evidence.",
        ),
        (
            "filing_form4",
            "bronze",
            "ownership_filing",
            "accession_number",
            "SEC Forms 3/4/5 ownership XML filing metadata with issuer, period, acceptance, source URL, and footnotes.",
            '["accession_number"]',
            "available_at is SEC acceptance time when available, otherwise conservative filing-date end-of-day.",
        ),
        (
            "insider_relationship",
            "silver",
            "insider_relationship",
            "insider_id,security_id,valid_from",
            "Bitemporal insider-to-issuer role rows with director/officer/10-percent-owner flags and normalized officer titles.",
            '["relationship_id"]',
            "Use valid_from/valid_to plus available_at for PIT role membership.",
        ),
        (
            "insider_transaction",
            "silver",
            "insider_transaction",
            "filing_id,insider_id,transaction_ordinal",
            "Section 16 non-derivative and derivative transaction rows with 28-code transaction taxonomy, direct/indirect ownership, 10b5-1 indicators, and derivative fields.",
            '["transaction_id"]',
            "Use transaction_date/as_of_date and available_at to avoid filing lookahead; rule_10b5_1_indicator splits planned sales.",
        ),
        (
            "insider_holding",
            "silver",
            "insider_holding",
            "filing_id,insider_id,holding_ordinal",
            "Current beneficial-ownership holding rows disclosed on Forms 3/4/5 without a transaction event.",
            '["holding_id"]',
            "Use as_of_date and available_at for PIT holdings snapshots.",
        ),
        (
            "tradingplan_10b5_1",
            "gold",
            "trading_plan",
            "insider_id,security_id,adoption_date",
            "Trading-plan rows reconstructed from post-2023 Form 4/5 10b5-1 indicators and adoption dates.",
            '["plan_id"]',
            "Cooling-off days are derived from adoption date to first visible transaction date.",
        ),
        (
            "blockholder_filing",
            "bronze",
            "blockholder_filing",
            "accession_number",
            "Schedule 13D/G blockholder filing landing table, including post-2024 XML flag and purpose text.",
            '["accession_number"]',
            "available_at and filing_date define public visibility; parser coverage is follow-on S3/S7 work.",
        ),
        (
            "blockholder_reporting_person",
            "silver",
            "blockholder_person",
            "filing_id,reporting_person_seq",
            "Reporting-person rows from Schedule 13D/G beneficial-owner filings.",
            '["reporting_person_id"]',
            "Joined to blockholder_filing for filing availability and issuer context.",
        ),
        (
            "fund",
            "silver",
            "fund",
            "registrant_cik,series_id",
            "N-PORT fund dimension landing table for registered investment-company holdings.",
            '["fund_id"]',
            "Fund lifecycle dates and source_loaded_at audit series visibility.",
        ),
        (
            "fund_class",
            "silver",
            "fund_class",
            "fund_id,class_external_id",
            "N-PORT fund share-class landing table.",
            '["class_id"]',
            "Ticker availability is source-reported and not a primary identity key.",
        ),
        (
            "filing_nport",
            "bronze",
            "nport_filing",
            "accession_number",
            "N-PORT filing metadata landing table.",
            '["accession_number"]',
            "available_at captures public filing visibility.",
        ),
        (
            "fund_holding",
            "silver",
            "fund_holding",
            "filing_id,security_id,asset_cat,payoff_profile",
            "N-PORT fund holding landing table including asset category, derivative/debt payloads, and loan flags.",
            '["holding_id"]',
            "Use period_of_report and available_at for PIT fund holdings.",
        ),
        (
            "form144_intent",
            "bronze",
            "form144_intent",
            "accession_number",
            "Form 144 restricted-stock intent-to-sell landing table.",
            '["accession_number"]',
            "Approximate sale date and filing availability support later Form 4 reconciliation.",
        ),
        (
            "form144_to_form4_link",
            "silver",
            "form144_reconciliation",
            "form144_filing_id,insider_transaction_id",
            "Reconciliation links from Form 144 sale intent to subsequent Form 4 actual transaction rows.",
            '["form144_filing_id","insider_transaction_id"]',
            "Match confidence records reconciliation quality.",
        ),
        (
            "proxy_vote",
            "silver",
            "proxy_vote",
            "filing_id,security_id,meeting_date,matter_description",
            "N-PX proxy-vote landing table with vote category and shares-voted fields.",
            '["proxy_vote_id"]',
            "available_at records filing visibility for engagement analytics.",
        ),
        (
            ...
            "congressional_disclosure",
            "disclosure_id",
            "STOCK Act congressional transaction-disclosure landing table.",
            '["disclosure_id"]',
            "filing_date and transaction_date expose disclosure lag as a feature.",
        ),
        (
            "finra_short_interest",
            "silver",
            "short_interest",
            "symbol,settlement_date,market_class_code",
            "FINRA consolidated short interest with latest-date full-market refresh and compact backfill support.",
            '["symbol","settlement_date","market_class_code"]',
            "available_at is conservatively stamped after settlement publication lag.",
        ),
        (
            "finra_short_interest_backfill_manifests",
            "control",
            "short_interest_backfill",
            "manifest_id",
            "FINRA all-symbol settlement-date backfill audit manifests.",
            '["manifest_id"]',
            "Records discovery candidates, selected settlement dates, loaded rows, feature rebuild rows, and run ids for repeatability.",
        ),
        (
            "macro_series",
            "bronze",
            ...
            '["source","series_id"]',
            "Series metadata layer for macro observations.",
        ),
        (
            "macro_observations",
            "silver",
            "macro",
            "series_id,observation_date,as_of_date",
            "Macro time series observations.",
            '["source","series_id","observation_date","as_of_date"]',
            "FRED graph CSV is latest-revision data; use ALFRED/FRED API vintages for true macro PIT revisions.",
        ),
        (
            "trading_calendar",
            "silver",
        ...
        (
            ...
            "universe_member",
            "universe_id,security_id,effective_date",
            "PIT universe memberships.",
            '["universe_id","security_id","effective_date","as_of_date"]',
            "Use as_of_date and source_loaded_at for as-of membership.",
        ),
        (
            "feature_definitions",
            "gold",
            ...
            "Feature metadata, expressions, source inputs, and PIT policy.",
            '["feature_set","feature_name"]',
            "Defines how each feature should be interpreted and when it is available.",
        ),
        (
            "feature_values",
            "gold",
            "feature",
            "feature_set,feature_name,security_id,as_of_date",
            "Alpha feature store.",
            '["feature_set","feature_name","security_id","as_of_date"]',
            "Computed from as-of-safe source inputs.",
        ),
        (
            "feature_build_manifests",
            "gold",
            "feature_manifest",
            "feature_set,run_id",
            "Feature build audit manifests.",
            '["feature_set","run_id"]',
            "Use manifests to audit feature value source windows and output counts.",
        ),
        (
            "feature_set_catalog",
            "gold",
            "feature_lineage",
            "feature_set",
            "Feature-set version/family catalog derived from loaded definitions.",
            '["feature_set"]',
            "Use version_label, feature_family, and input_tables_json to audit feature-set compatibility.",
        ),
        (
            "feature_dependency_edges",
            "gold",
            "feature_lineage",
            "feature_set,feature_name,dependency_name",
            "Feature dependency graph linking features to source tables and derived feature inputs.",
            '["feature_set","feature_name","dependency_type","dependency_name"]',
            "Source-table and same-set derived-feature edges are rebuilt from feature definitions.",
        ),
        (
            ...
            "alpha_expression",
            "alpha_id",
            "Alpha expression registry with input features, PIT policy, weighting, ranking, and evaluation horizon metadata.",
            '["alpha_id"]',
            "Expressions are metadata; use input_features_json, available_at_policy, and params_json to audit signal construction.",
        ),
        (
            "alpha_signal_values",
            "gold",
            "alpha_signal",
            "alpha_id,security_id,as_of_date",
            "Materialized PIT alpha signals, cross-sectional ranks, and daily long/short weights.",
            '["alpha_id","security_id","as_of_date"]',
            "available_at is inherited from feature inputs; weights are computed cross-sectionally with no forward-return inputs.",
        ),
        (
            ...
            "alpha_backtest",
            "backtest_id",
            "Alpha backtest summary manifests with evaluation window, signal counts, rank IC, hit rate, and long/short return metrics.",
            '["backtest_id"]',
            "Forward returns appear only in evaluation manifests; signal values remain PIT-safe research inputs.",
        ),
        (
            "security_identifiers",
            "legacy",
            "identifier",
            "symbol,id_type,id_value",
            "Legacy symbol identifier helper table.",
            '["symbol","id_type","id_value"]',
            "Prefer security_identifier_history for PIT research joins.",
        ),
        (
            "tbltickerhistory",
            "view",
            "price",
            "source,vendor_security_id,trading_date",
            "Compatibility view over tbltickerhistory_daily.",
            '["source","vendor_security_id","trading_date"]',
            "Raw local archive view; prefer equity_daily_bars for canonical research joins.",
        ),
        (
            ...
            '["security_id"]',
            "Convenience view; not point-in-time.",
        ),
        (
            ...
            "price_return",
            "security_id,trade_date",
            "Daily simple/log return view.",
            '["source","security_id","trade_date"]',
            "Uses only same-day and prior closes.",
        ),
        (
            "v_alpha_daily_panel",
            "view",
            ...
            "Daily alpha panel convenience view.",
            '["security_id","as_of_date"]',
            "Uses canonical bars and daily returns.",
        ),
        (
            "v_fundamental_points_latest",
            "view",
            "fundamental",
            "security_id,metric,period_end,unit",
            "Latest fundamental points by period.",
            '["security_id","metric","period_end","unit"]',
            "Current latest view; use as-of helper for PIT queries.",
        ),
        (
            "v_fundamental_statement_latest",
            "view",
            "fundamental_statement",
            "security_id,canonical_metric,period_end,unit",
            "Latest normalized statement points by canonical metric and period.",
            '["security_id","canonical_metric","period_end","unit"]',
            "Current latest view; use statement as-of helper for PIT queries.",
        ),
        (
            "v_fundamental_ttm_latest",
            "view",
            "fundamental_ttm",
            "security_id,canonical_metric,ttm_end_date,unit",
            "Latest trailing-twelve-month statement values by canonical metric and TTM end date.",
            '["security_id","canonical_metric","ttm_end_date","unit"]',
            "Current latest view; use TTM as-of helper for PIT queries.",
        ),
        (
            ...
            "fundamental_period",
            "period_group_id",
            "Latest normalized reporting-period rows by period group.",
            '["period_group_id"]',
            "Current latest view; use fundamental_periods for PIT-safe period alignment.",
        ),
        (
            "v_sec_latest_filings",
            "view",
            "filing",
            "security_id,form",
            "Latest SEC filing by security and form.",
            '["security_id","form"]',
            "Current latest view; use filing dates for as-of workflows.",
        ),
        (
            "v_macro_latest",
            "view",
            ...
            '["series_id","observation_date"]',
            "Latest-revision macro view.",
        ),
        (
            "v_finra_short_interest_latest",
            "view",
            "short_interest",
            "symbol",
            "Latest FINRA short interest by symbol.",
            '["symbol"]',
            "Current latest view; use settlement_date/available_at for PIT.",
        ),
        (
            ...
            "13f_positioning",
            "source_period,cusip",
            "Aggregated 13F positioning by CUSIP and source period.",
            '["source_period","cusip"]',
            "Use report_period and source_period for availability modeling.",
        ),
    ]
