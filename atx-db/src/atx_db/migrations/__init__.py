...
globals().pop("bodies_0278", None)
globals().pop("bodies_0279", None)
globals().pop("bodies_0280", None)
globals().pop("bodies_0281", None)
globals().pop("bodies_0282", None)
globals().pop("bodies_0283", None)
globals().pop("bodies_0284", None)
globals().pop("bodies_0285", None)
globals().pop("bodies_0286", None)
globals().pop("bodies_0287", None)
globals().pop("bodies_0288", None)
globals().pop("bodies_0289", None)
globals().pop("bodies_0290", None)
globals().pop("bodies_0291", None)
globals().pop("bodies_0292", None)
globals().pop("bodies_0293", None)
