#!/usr/bin/env python
"""Build PIT annual change in approximate net-operating-asset turnover."""
...
from atx_db.noa_proxy_turnover_change import (
    ...
    refresh_noa_proxy_turnover_change_values,
)
...
def main() -> int:
    ...
    options = NoaProxyTurnoverChangeOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_noa_proxy_turnover_change_values(store, options)
