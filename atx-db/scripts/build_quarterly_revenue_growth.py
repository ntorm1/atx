#!/usr/bin/env python
"""Build PIT same-quarter year-over-year revenue growth."""
...
from atx_db.quarterly_revenue_growth import (
    ...
    refresh_quarterly_revenue_growth_values,
)
...
def main() -> int:
    ...
    options = QuarterlyRevenueGrowthOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_quarterly_revenue_growth_values(store, options)
