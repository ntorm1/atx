#!/usr/bin/env python
"""Build PIT quarterly inventory-change and inventory-growth factors."""
...
from atx_db.quarterly_inventory_investment import (
    ...
    refresh_quarterly_inventory_investment_values,
)
...
def main() -> int:
    ...
    parser.add_argument("--maximum-absolute-inventory-change", type=float, default=5.0)
    ...
    options = QuarterlyInventoryInvestmentOptions(
        ...
        maximum_absolute_inventory_change=args.maximum_absolute_inventory_change,
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_quarterly_inventory_investment_values(store, options)
