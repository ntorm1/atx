#!/usr/bin/env python
"""Build the PIT eight-observation quarterly asset-turnover trend."""
...
from atx_db.asset_turnover_trend import (
    ...
    refresh_asset_turnover_trend_values,
)
...
def main() -> int:
    ...
    options = AssetTurnoverTrendOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_asset_turnover_trend_values(store, options)
