#!/usr/bin/env python
"""Build point-in-time four-quarter change in quarterly ROE."""
...
from atx_db.delta_roe import FACTOR_ID, DeltaRoeOptions, refresh_delta_roe_values
...
def main() -> int:
    ...
    parser.add_argument("--minimum-period-gap-days", type=int, default=300)
    parser.add_argument("--maximum-period-gap-days", type=int, default=430)
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_delta_roe_values(store, options)
