#!/usr/bin/env python
"""Build the corrected PIT public-company Altman Z-score."""
...
from atx_db.altman_distress import (
    ...
    refresh_altman_distress_values,
)
...
def main() -> int:
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_altman_distress_values(store, options)
