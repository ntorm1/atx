#!/usr/bin/env python
"""Build PIT twin profitability-trend and price momentum."""
...
from atx_db.twin_momentum import FACTOR_ID, TwinMomentumOptions, refresh_twin_momentum_values
...
def main() -> int:
    ...
    with DuckDBStore(args.db_path) as store:
        count = refresh_twin_momentum_values(store, options)
