#!/usr/bin/env python
"""Build PIT earnings-persistence-weighted SUE."""
...
from atx_db.earnings_persistence import (
    ...
    refresh_earnings_persistence_values,
)
...
def main() -> int:
    ...
    options = EarningsPersistenceOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        count = refresh_earnings_persistence_values(store, options)
