#!/usr/bin/env python
"""Build the point-in-time low net-operating-assets factor."""
...
from atx_db.net_operating_assets import (
    ...
    refresh_net_operating_assets_values,
)
...
def main() -> int:
    ...
    options = NetOperatingAssetsOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        count = refresh_net_operating_assets_values(store, options)
