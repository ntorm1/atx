#!/usr/bin/env python
"""Build point-in-time quarterly gross profits-to-lagged-assets."""
...
from atx_db.quarterly_gross_profitability import (
    ...
    refresh_quarterly_gross_profitability_values,
)
...
def main() -> int:
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_quarterly_gross_profitability_values(store, options)
