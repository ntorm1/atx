#!/usr/bin/env python
"""Build point-in-time quarterly cash operating profits-to-lagged-assets."""
...
from atx_db.quarterly_cash_profitability import (
    ...
    refresh_quarterly_cash_profitability_values,
)
...
def main() -> int:
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_quarterly_cash_profitability_values(store, options)
