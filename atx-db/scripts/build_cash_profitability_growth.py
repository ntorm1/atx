#!/usr/bin/env python
"""Build the governed PIT cash-profitability level-growth composite."""
...
def main() -> int:
    ...
    options = CashProfitabilityGrowthOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        count = refresh_cash_profitability_growth_values(store, options)
