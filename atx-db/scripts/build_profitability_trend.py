#!/usr/bin/env python
"""Build the PIT eight-quarter gross-profitability-trend factor."""
...
from atx_db.profitability_trend import (
    ...
    refresh_profitability_trend_values,
)
...
def main() -> int:
    ...
    options = ProfitabilityTrendOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_profitability_trend_values(store, options)
