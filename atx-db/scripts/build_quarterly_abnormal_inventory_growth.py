#!/usr/bin/env python
"""Build PIT same-quarter sales-adjusted inventory growth."""
...
from atx_db.quarterly_abnormal_inventory_growth import (
    ...
    refresh_quarterly_abnormal_inventory_growth_values,
)
...
def main() -> int:
    ...
    parser.add_argument("--minimum-period-gap-days", type=int, default=330)
    parser.add_argument("--maximum-period-gap-days", type=int, default=400)
    parser.add_argument("--maximum-absolute-component-growth", type=float, default=10.0)
    parser.add_argument("--maximum-absolute-raw-value", type=float, default=10.0)
    ...
    options = QuarterlyAbnormalInventoryGrowthOptions(
        ...
        minimum_period_gap_days=args.minimum_period_gap_days,
        maximum_period_gap_days=args.maximum_period_gap_days,
        maximum_absolute_component_growth=args.maximum_absolute_component_growth,
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_quarterly_abnormal_inventory_growth_values(store, options)
