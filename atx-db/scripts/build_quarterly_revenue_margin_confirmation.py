#!/usr/bin/env python
"""Build revenue growth gated by non-declining gross margin."""
...
from atx_db.quarterly_revenue_margin_confirmation import (
    ...
    refresh_quarterly_revenue_margin_confirmation_values,
)
...
def main() -> int:
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_quarterly_revenue_margin_confirmation_values(store, options)
