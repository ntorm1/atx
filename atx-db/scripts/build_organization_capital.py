#!/usr/bin/env python
"""Build the governed point-in-time organization-capital factor."""
...
def main() -> int:
    ...
    parser.add_argument("--depreciation-rate",type=float,default=0.15)
    parser.add_argument("--initial-growth-rate",type=float,default=0.10)
    parser.add_argument("--minimum-history-observations",type=int,default=5)
    parser.add_argument("--maximum-reporting-age-days",type=int,default=550)
    parser.add_argument("--maximum-history-days",type=int,default=8000)
    parser.add_argument("--maximum-raw-value",type=float,default=20.0)
    ...
    options = OrganizationCapitalOptions(
        start_date=args.start_date,end_date=args.end_date,
        depreciation_rate=args.depreciation_rate,
        initial_growth_rate=args.initial_growth_rate,
    ...
    with DuckDBStore(args.db_path) as store:
        count = refresh_organization_capital_values(store,options)
