#!/usr/bin/env python
"""Build the point-in-time QMJ-style profitability factor."""
...
from atx_db.qmj_profitability import (
    ...
    refresh_qmj_profitability_values,
)
...
def main() -> int:
    ...
    options = QmjProfitabilityOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_qmj_profitability_values(store, options)
