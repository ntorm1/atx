#!/usr/bin/env python
"""Build point-in-time low quarterly operating working-capital accruals."""
...
from atx_db.quarterly_working_capital_accruals import (
    ...
    refresh_quarterly_working_capital_accruals_values,
)
...
def main() -> int:
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_quarterly_working_capital_accruals_values(store, options)
