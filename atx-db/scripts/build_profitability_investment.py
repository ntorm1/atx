#!/usr/bin/env python
"""Build the governed joint cash-profitability and conservative-investment factor."""
...
def main() -> int:
    ...
    options = ProfitabilityInvestmentOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        count = refresh_profitability_investment_values(store, options)
