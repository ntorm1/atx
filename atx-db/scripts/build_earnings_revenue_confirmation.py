#!/usr/bin/env python
"""Build the SUE / quarterly-revenue-surprise confirmation factor."""
...
from atx_db.earnings_revenue_confirmation import (
    ...
    refresh_earnings_revenue_confirmation_values,
)
...
def main() -> int:
    ...
    options = EarningsRevenueConfirmationOptions(
        minimum_names_per_date=args.minimum_names_per_date,
        run_id=args.run_id,
    )
    with DuckDBStore(args.db_path) as store:
        rows = refresh_earnings_revenue_confirmation_values(store, options)
