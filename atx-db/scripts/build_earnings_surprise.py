#!/usr/bin/env python
"""Build first-filed standardized unexpected diluted EPS."""
...
from atx_db.earnings_surprise import (
    FACTOR_ID,
    EarningsSurpriseOptions,
    refresh_earnings_surprise_values,
)
...
def main() -> int:
    ...
    options = EarningsSurpriseOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_earnings_surprise_values(store, options)
