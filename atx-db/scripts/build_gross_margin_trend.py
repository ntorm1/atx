#!/usr/bin/env python
"""Build the PIT eight-observation quarterly gross-margin trend."""
...
from atx_db.gross_margin_trend import (
    ...
    refresh_gross_margin_trend_values,
)
...
def main() -> int:
    ...
    options = GrossMarginTrendOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        rows = refresh_gross_margin_trend_values(store, options)
