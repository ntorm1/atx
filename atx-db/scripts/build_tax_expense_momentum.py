#!/usr/bin/env python
"""Build the governed point-in-time tax-expense momentum factor."""
...
def main() -> int:
    ...
    parser.add_argument("--maximum-absolute-raw-value", type=float, default=1.0)
    ...
    options = TaxExpenseMomentumOptions(
    ...
    with DuckDBStore(args.db_path) as store:
        count = refresh_tax_expense_momentum_values(store, options)
