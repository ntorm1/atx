...
[[nodiscard]] atx::core::Result<Genome> SearchDriver::make_child(const std::vector<Scored> &scored,
...
[[nodiscard]] atx::core::Result<Genome> SearchDriver::mutate_one(const Genome &g,
                                                                 const SearchConfig &cfg,
                                                                 Xoshiro256pp &rng) {
...
[[nodiscard]] const Genome &SearchDriver::tournament_pick(const std::vector<Scored> &scored,
                                                          const std::vector<atx::usize> &canon_order,
