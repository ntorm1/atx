...
//
// S7-3 ships exactly one workload — `Test` (a self-contained deterministic
// arithmetic kernel). S7-5 appends Eval/Cpcv/Backtests/Mine here; the WorkloadId
// dispatch is otherwise unchanged.
...
int main(int argc, char **argv) {
  ...
  atx::engine::parallel::register_workload(atx::engine::parallel::WorkloadId::Test,
                                           &atx::engine::parallel::test_shard);
  return atx::engine::parallel::run_shm_worker(argc, argv);
}
