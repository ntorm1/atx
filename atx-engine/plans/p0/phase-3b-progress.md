...
| `_(SHA pending)_` | P3b-4 (alpha101 conformance battery + floor(d) + 5 semantic locks) | AlphaConformance 15/15; full Alpha 333/333; whole binary 1388/1388; 0 fail / 0 skip (+15 new TEST blocks, +1 typecheck split) |
| `_(SHA pending)_` | P3b-4 fix (reject out-of-range window literal before u16 cast) | AlphaTypecheck_Window 6/6; full Alpha 334/334; 0 fail / 0 skip (+1 OverMaxWindow test; meta-count pins) |
