...
| _(SHA pending)_ | P3c-3 refactor | alloc-hygiene (real field-scratch reuse + static field names); VmSignalSource 10/10; Alpha 358/358; exec/loop 97/97; `/W4 /WX` clean |
