...
**Status:** 🟡 OPEN — 2026-06-14 (S4.4a shipped; suite 1333 pass / 5 disabled)
...
| S4.4b | Lockbox reservation/seal (`eval/lockbox.hpp`) + `research_driver` robustness-gate hook | ⬜ | — | — | sub-split per plan §4.4 |
