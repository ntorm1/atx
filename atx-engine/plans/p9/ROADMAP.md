...
- **Book-level turnover gate + participation cap (S5)** already apply to `stage_metabook` (S5-1/S5-2 wire both stage_optimize AND stage_metabook) — the mega-book IS measured + gated. ✓
