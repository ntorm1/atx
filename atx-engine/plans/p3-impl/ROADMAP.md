...
| 1.4 | **Universe / market-cap / liquidity / sector** — `shares_outstanding`→market cap; trailing-ADV liquidity screen; GICS sector field; PIT membership mask; **survivorship caveat documented** | Moderate | ✅ `<S1-4-SHA>` | S1-4 | `data/universe.{hpp,cpp}` + test |
