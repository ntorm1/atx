...
//
// Header + src split: the hot online filter (regime_posterior_at and the forward
// recursion it shares) plus the tiny math helpers stay inline; the COLD training /
// in-sample paths (Baum-Welch / EM, seeded init, the independent backward pass,
// posterior_decode, global stats) move to src/learn/hmm.cpp. Fitting is a COLD path
// (once per training window), so std::vector / Eigen allocation is fine.
...
[[nodiscard]] hmm_lin::MatX backward_beta(const Hmm &h, const hmm_lin::MatX &obs,
...
void global_stats(const hmm_lin::MatX &obs, hmm_lin::VecX &mean_out, hmm_lin::VecX &var_out);
...
[[nodiscard]] Hmm seeded_init(const hmm_lin::MatX &obs, const HmmCfg &cfg);
...
[[nodiscard]] atx::f64 em_step(Hmm &h, const hmm_lin::MatX &obs, atx::f64 var_floor);
...
// ===========================================================================
[[nodiscard]] Hmm baum_welch(const hmm_lin::MatX &obs, const HmmCfg &cfg);
...
// ===========================================================================
[[nodiscard]] atx::f64 backward_loglik(const Hmm &hmm, const hmm_lin::MatX &obs);
...
// ===========================================================================
[[nodiscard]] std::vector<atx::u32> posterior_decode(const Hmm &hmm, const hmm_lin::MatX &obs);
