...
- Work in a leased pool worktree: `powershell scripts\lease-worktree.ps1 -Branch feat/deriv-prod-sprint`. Commit per task, message style `feat(vol): ...` / `fix(vol): ...`, trailer `Co-Authored-By: Claude Fable 5 <noreply@anthropic.com>`.
