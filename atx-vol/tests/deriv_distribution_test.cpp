...
#include "fitting/counters.hpp"  // Task F-5: the dispatch-level strip-eval witness
#include "analytics/rv_lognormal.hpp"
#include "deriv_fixtures.hpp"  // Task 0: deriv_testkit::make_skew_surface (C-5 fixture)
