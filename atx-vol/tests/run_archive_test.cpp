...
#include "atx/vol/api/backtest/backtest.hpp"            // BacktestResult (Task 5 encoders)
#include "backtest/backtest_series_columns.hpp" // backtest_series_columns() (T6 single source)
#include "atx/vol/api/marketdata/corpus.hpp"              // CorpusManifest (RunDir::clock via manifest)
#include "storage/archive_util.hpp" // crc32c (independent CRC check)
#include "atx/vol/research/dispersion_workflow.hpp" // RunSpec (Task 5 meta encoder)
#include "atx/vol/api/backtest/listed_dispersion.hpp"   // ListedDispersionSelection (RunDir schedule fixture)
#include "atx/vol/research/listed_dispersion_reconciliation.hpp"
#include "atx/vol/api/backtest/listed_dispersion_schedule.hpp"
#include "atx/vol/api/storage/surface_archive.hpp" // ArchiveContentIdentity (identity())
