...
// (`atx/vol/detail/legacy_surface.hpp`) — the surface type `derivatives.hpp`'s
...
#include "atx/vol/detail/legacy_surface.hpp" // EssviSurface
#include "atx/vol/rates_curve.hpp"           // CurveSet, ForwardPoint
#include "atx/vol/surface.hpp"               // EssviSlice
#include "atx/vol/types.hpp"                 // Status
#include "atx/vol/vol_surface.hpp"           // essvi_phi_max
