...
#include "pricing/deriv_ref_bridge.hpp"         // Task P-6: unmemoized detail::*_on_ref reference
#include "pricing/strip_grid.hpp"               // strip::kCertifiedWingHalfBand (Task C-6)
...
#include "atx/vol/api/fitting/surface_policy.hpp"  // certified_wing_half_band (Task C-6)
