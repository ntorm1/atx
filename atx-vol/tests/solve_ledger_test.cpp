...
#include "atx/vol/api/pricing/american.hpp"         // al_fast_opts, AmericanMethod, american_price
#include "atx/vol/api/pricing/american_iv.hpp"      // american_implied_vol (iv-newton tap)
#include "atx/vol/api/backtest/backtest.hpp"         // Clock, run_backtest, RunConfig, Lot, PortfolioState
#include "atx/vol/api/marketdata/corpus.hpp"           // CorpusManifest, CorpusEntry, CorpusFitStatus
#include "fitting/counters.hpp"         // counters::ledger — the facility under test
...
#include "atx/vol/api/backtest/strategy.hpp"         // DeclarativeStrategy, StrategySpec, StrikeSelector
