...
#include "atx/vol/api/core/types.hpp"       // Task F-4: kCalendarTotalVarianceTol
#include "atx/vol/api/pricing/black76.hpp"  // WingClamp oracle repricing
#include "atx/vol/api/pricing/derivatives.hpp"
#include "fitting/counters.hpp"                 // ledger:: (Corridor dispatch witness)
...
#include "fitting/risk_surface_validation.hpp"  // RiskSurfaceValidationConfig (MUST-FIX 2)
...
#include "atx/vol/api/fitting/surface_policy.hpp"  // FitQualityMode, certified_wing_half_band (C-6)
#include "atx/vol/api/fitting/vol_curve.hpp"  // CurveSurface, EssviCurve (C-6 fixture)
