...
#include "atx/vol/api/backtest/backtest.hpp" // Clock, RunConfig, BacktestResult, MarketSnapshot, SnapshotCache
...
#include "fitting/counters.hpp"        // always-on sampled pricing telemetry
