...
#include "atx/vol/api/pricing/american.hpp"       // AmericanGreeks, AmericanMethod, AlOpts
#include "atx/vol/api/backtest/priced_surface.hpp" // PricedSurface (nested contract types), PricingContext
#include "atx/vol/api/simd/cpu.hpp"       // SimdIsa
#include "atx/vol/api/core/types.hpp"          // Result, Status, Side
#include "atx/vol/api/fitting/vol_curve.hpp"      // IVolCurve, VolCurveKind
