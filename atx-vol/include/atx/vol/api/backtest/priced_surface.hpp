...
#include "atx/vol/api/pricing/american.hpp" // AmericanGreeks, AmericanMethod, AlOpts, american_price/greeks
#include "atx/vol/api/backtest/query_pricing.hpp"  // QueryPricingRoute, QueryPricingTier
#include "atx/vol/api/simd/cpu.hpp"       // SimdIsa (call-local resolved price route)
#include "atx/vol/api/fitting/surface_parity.hpp" // SliceContext
#include "atx/vol/api/core/types.hpp"          // Result, Status, Side
#include "atx/vol/api/fitting/vol_curve.hpp"      // CurveSurface, VolCurveKind
