...
#include "atx/vol/api/backtest/backtest.hpp"                   // Lot, MarketSnapshot, PortfolioState
#include "atx/vol/api/backtest/listed_dispersion_schedule.hpp" // ListedDispersionSchedule
#include "atx/vol/api/backtest/strategy.hpp"                   // IStrategy, HedgeSpec
