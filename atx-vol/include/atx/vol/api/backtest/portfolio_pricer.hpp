...
#include "atx/vol/api/pricing/dividend.hpp"            // DividendEvent, HybridDivParams
...
// portfolio_index_count_is_representable (the checked-narrowing seam shared by
// Portfolio::create and its boundary test) is split out of this public header
// (Task 6, atx-vol API restructure): its repo-wide production use is confined
// to portfolio_pricer.cpp's own TU. See src/backtest/portfolio_pricer_detail.hpp.
