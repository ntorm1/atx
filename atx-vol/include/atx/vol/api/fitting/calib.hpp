...
#include "atx/vol/api/pricing/american.hpp"    // AlOpts (de-Am Andersen-Lake accuracy preset)
#include "atx/vol/api/fitting/correction.hpp"  // AmericanCorrectionCaches (optional de-Am hot path)
#include "atx/vol/api/core/types.hpp"       // Side, Result
#include "atx/vol/api/marketdata/universe.hpp"    // Chain (SoA quote layout)
#include "atx/vol/api/fitting/vol_surface.hpp" // ResidualBasisKind (reused, not redefined)
