...
#include "atx/vol/api/fitting/dense_slice.hpp"  // ConvexSliceFit, ConvexFitOpts
#include "atx/vol/api/fitting/spline_curve.hpp" // SplineVolParams, SplineFitOpts, kSrMoneynessGrid
