...
| P6 | in-flight | | dispatched (build-rel-avx2, freed by P5); files deamer.cpp+american_iv.cpp disjoint from G4's american.*. Counters-ON sweep (P5 gate, P6 gate, P7 rider) consolidated as one task after G1 frees build-counters |
