...
| W0.1 Canonical end-to-end bench | pending | — | Real OPRA baseline and required benchmark-name gate. |
| W0.2 Always-on lightweight counters | pending | — | Must demonstrate <1% overhead. |
| W0.3 Accuracy harness | pending | — | Stable SPY + 100-name economic regression CSV. |
