...
#include "atx/vol/api/pricing/american.hpp"    // american_price, american_price_cached
#include "atx/vol/api/pricing/black76.hpp"     // black76_value_and_vega
#include "atx/vol/api/fitting/correction.hpp"  // CorrectionCache (hot-path re-pricing)
#include "atx/vol/api/fitting/fit_metrics.hpp" // vol_error_bar, reduced_chi_square, minimum_edge
