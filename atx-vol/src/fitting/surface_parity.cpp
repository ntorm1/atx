...
#include "fitting/risk_surface_validation.hpp" // RiskSurfaceValidationConfig (repair band tie)
#include "pricing/strip_grid.hpp"              // strip::kCertifiedWingHalfBand (band tie)
...
#include "fitting/prepared_fitting.hpp" // PreparedSlice legacy compatibility seam
