...
#include "atx/vol/api/pricing/american.hpp" // american_price_cached
#include "atx/vol/api/fitting/arb.hpp"      // arb_check_butterfly_slice (opt-in no-arb sweep)
#include "atx/vol/api/pricing/black76.hpp"  // black76_price
#include "atx/vol/api/analytics/event_vol.hpp"  // EventSchedule, count_events_at, event_aware_w
#include "pricing/strip_grid.hpp" // strip::forward_log_blend (E2 shared convention)
