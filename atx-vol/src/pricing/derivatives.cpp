...
#include "fitting/risk_surface_validation.hpp" // RiskSurfaceValidationConfig (wing-clamp band assert)
#include "analytics/rv_lognormal.hpp" // lognormal_call, truncated_expect, norm_cdf (Tasks 4-5)
#include "atx/vol/api/backtest/portfolio_pricer.hpp" // Task 9: SurfaceRef (the borrowed-surface handle)
