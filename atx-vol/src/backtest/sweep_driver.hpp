...
#include "atx/vol/api/backtest/backtest.hpp"             // Clock, RunConfig, BacktestResult
#include "backtest/backtest_template.hpp"    // BacktestStrategyTemplate
#include "marketdata/catalog.hpp"     // Catalog (D3)
#include "storage/snapshot_pool.hpp" // SnapshotPool (C2)
#include "storage/track_key.hpp"   // TrackKey (D1)
#include "storage/track_store.hpp" // TrackStore, TrackMeta (D2)
