...
#include "atx/vol/api/storage/surface_archive.hpp" // ArchiveV2SurfaceHeader + v2 layout

#include "atx/vol/api/pricing/american.hpp"       // american_price / greeks / delta / vega (free fns)
#include "atx/vol/api/pricing/american_batch.hpp" // ResolvedAmericanPriceBatchRequest, american_price_batch_resolved
#include "atx/vol/api/fitting/c8.hpp"            // C8Params, c8_slice_w
#include "fitting/counters.hpp" // mapped heavy-curve materialization counter
#include "atx/vol/api/fitting/dense_slice.hpp"   // ConvexSliceFit
#include "atx/vol/api/fitting/spline_curve.hpp"  // SplineVolParams
#include "atx/vol/api/fitting/vol_curve.hpp"     // Convex/Spline/Essvi/Svi/C8/LinearVariance curves, VolCurveKind
#include "atx/vol/api/fitting/vol_surface.hpp"   // EssviParams, SviParams, essvi_total_w, svi_total_w
#include "backtest/laned_greek_run.hpp"      // WS-P1v: the shared laned analytic-Greek batch driver
#include "backtest/term_carry.hpp"            // interpolate_positive_log, coherent_q_eff
...
Status PricedSurfaceView::evaluate_batch(std::span<const double> K, std::span<const double> T,
  ...
  if (mapped && detail::laned_greek_route_selected(want_greeks, selective_only, want_delta,
                                                   want_vega, analytic, pricing_.method,
                                                   resolved_price_isa)) {
