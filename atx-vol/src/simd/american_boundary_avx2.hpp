...
// Price n American puts (homogeneous ACCURATE scheme) into price_out, 4 lanes at a
// time on AVX2. Degenerate / non-American / collapse / deep-wing / non-finite
// lanes and the n % 4 tail patch through the scalar andersen_lake, so the result
// matches the scalar batch to the P3 accuracy gate.
