...
#include "atx/vol/api/storage/surface_db.hpp"          // SurfaceDb (manifest symbol table)
#include "atx/vol/api/core/types.hpp" // Result / Status / ErrorCode (atx-vol's Result include)
