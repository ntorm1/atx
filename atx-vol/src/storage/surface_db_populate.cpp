...
#include "storage/archive_util.hpp"  // canonicalize_symbol (carry-over key match)
#include "fitting/fit_scheduler.hpp" // run_bounded_fit_tasks
#include "atx/vol/api/backtest/dispersion.hpp"           // with_uid
#include "core/parallel_for.hpp"         // atx_auto_worker_count (fit_workers=0 auto)
#include "atx/vol/api/fitting/pricer_fitter.hpp"        // PricerConfig
#include "atx/vol/api/backtest/priced_surface.hpp"       // PricedSurface::tenor_domain (Task 3 max_T_min)
#include "atx/vol/api/fitting/session.hpp"              // SessionInputs
#include "atx/vol/api/marketdata/universe.hpp"             // uid_for_symbol
#include "marketdata/corpus_board_fit.hpp"             // FitSlot, fit_board (shared blessed fit path)
#include "storage/surface_db_seed.hpp"              // seed_symbol_config (shared index/preset seed recipe)
