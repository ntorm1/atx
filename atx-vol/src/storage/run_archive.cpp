...
#include "atx/vol/api/backtest/backtest.hpp"            // BacktestResult, Clock (Task 5 encoders / RunDir)
#include "backtest/backtest_series_columns.hpp" // backtest_series_columns() (T6 single source)
#include "atx/vol/api/marketdata/corpus.hpp"              // CorpusManifest, read_manifest_file (RunDir::clock)
#include "storage/archive_util.hpp" // crc32c, crc32c_update, align_up
...
#include "atx/vol/api/storage/surface_archive.hpp" // ArchiveContentIdentity (F6 identity)
#include "atx/vol/api/core/version.hpp"         // semantic producer version dependency
