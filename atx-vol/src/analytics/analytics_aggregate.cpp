...
#include "atx/vol/api/analytics/event_vol.hpp"      // count_events_at, implied_emove_joint
#include "atx/vol/api/backtest/priced_surface.hpp" // PricedSurface, PricingContext
#include "atx/vol/api/fitting/pricer_fitter.hpp"  // PricerFitter, FittedSurface
#include "atx/vol/api/fitting/session.hpp"        // VolaSession, SessionInputs, SessionDiagnostics
