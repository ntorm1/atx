...
| 2 | Estimates (IBES/consensus) | ~11 | est_measure, est_actual, est_surprise, est_broker, est_broker_alias, est_analyst, est_analyst_alias, est_period_dim, est_detail, est_consensus, est_guidance, est_recommendation, est_recommendation_summary, est_security_link | SEC-derived actuals/SUE plus injectable detail/consensus/guidance/recommendation landing surfaces and PIT-safe vendor-security-id links | public guidance NER not built; default DB has no licensed broker-detail/consensus/recommendation/security-link rows | build_estimates.py, estimates.py, estimate_security_links.py | 2 (extend) |
...
**Gap:**
- Populated licensed/public estimate feeds and accepted estimate crosswalk rows are not in the default DB. Full parity still needs real IBES/FactSet/CIQ/Zacks detail/summary/recommendation/price-target files and SEC 8-K Item 2.02/7.01 guidance NER.
