...
- **2023-01-03 value-unit cutover** (×1000 multiplier for `periodOfReport ≤ 2022-12-31`): **still open** — `thirteenf.normalize_holdings` does not scale `value_usd` by vintage (`thirteenf.py:199`). No live impact (all loaded periods are post-2023, factor = 1) but pre-2023 backfills would be 1000× understated. Next focused tranche (S6b).
