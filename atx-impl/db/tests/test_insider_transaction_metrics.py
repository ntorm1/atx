...
def test_insider_transaction_metrics_accept_string_10b5_1_flags():
    ...
    from db.insider_metrics import InsiderTransactionMetricsOptions, compute_insider_transaction_metrics
...
def test_insider_transaction_metrics_preserve_late_filing_revisions(tmp_store, tmp_path):
    from db.asof import insider_transaction_metrics_asof
    from db.insider_metrics import InsiderTransactionMetricsOptions, refresh_insider_transaction_metrics
