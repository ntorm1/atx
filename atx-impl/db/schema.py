...
def _seed_catalog(store: DuckDBStore) -> None:
    ...
    dataset_rows = [
        ...
        ("fundamental_statement_map", "sec_edgar", "Fundamental statement map", "Canonical statement mappings from SEC XBRL concepts into normalized income statement, balance sheet, cash-flow, per-share, and share-count metrics.", "source,taxonomy,concept", "fundamental_statement_map", "updated_at", "updated_at"),
        ...
        ("fundamental_periods", "sec_edgar", "Fundamental fiscal periods", "PIT-safe normalized reporting-period windows derived from SEC statement points with reported fiscal labels, actual period dates, calendar buckets, and revision coverage.", "security_id,period_start,period_end,accession", "fundamental_periods", "as_of_date", "available_at"),
    ...
    table_rows = [
        ...
        ("fundamental_statement_map", "catalog", "fundamental_statement_map", "source,taxonomy,concept", "Canonical statement mapping for loaded SEC XBRL concepts.", '["source","taxonomy","concept"]', "Seeded public taxonomy mapping; updated_at records mapping refresh."),
        ...
        ("fundamental_periods", "silver", "fundamental_period", "source,security_id,period_start,period_end,accession_number", "Normalized fiscal/reporting-period windows derived from statement facts.", '["source","security_id","period_start","period_end","accession_number"]', "Use actual period_start/period_end plus available_at/revision_sequence for PIT-safe period alignment; reported fiscal labels are preserved as evidence JSON."),
