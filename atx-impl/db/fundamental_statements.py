...
FUNDAMENTAL_STATEMENT_MAP_ROWS: tuple[FundamentalStatementMapRow, ...] = (
    ...
    # 1044-1049 PF3-S5 float, treasury, and common-share classes
    FundamentalStatementMapRow(SOURCE_NAME,"dei","EntityPublicFloat","share_count","shares","float","Public float shares","instant","credit","shares",1.0,10,False,True,"Public-float disclosure when the source fact is share-denominated; monetary public-float facts are excluded by the share-history loader.",1044,"ALL",False,None),
    FundamentalStatementMapRow(SOURCE_NAME,"us-gaap","TreasuryStockShares","share_count","shares","treasury","Treasury shares","instant","debit","shares",1.0,10,False,True,"Treasury shares held by the issuer.",1045,"ALL",False,None),
    FundamentalStatementMapRow(SOURCE_NAME,"us-gaap","ClassACommonStockSharesOutstanding","share_count","shares","class_a","Class A common shares outstanding","instant","credit","shares",1.0,10,False,True,"Class A common shares outstanding.",1046,"ALL",False,None),
    FundamentalStatementMapRow(SOURCE_NAME,"us-gaap","ClassBCommonStockSharesOutstanding","share_count","shares","class_b","Class B common shares outstanding","instant","credit","shares",1.0,10,False,True,"Class B common shares outstanding.",1047,"ALL",False,None),
    FundamentalStatementMapRow(SOURCE_NAME,"us-gaap","ClassCCommonStockSharesOutstanding","share_count","shares","class_c","Class C common shares outstanding","instant","credit","shares",1.0,10,False,True,"Class C common shares outstanding.",1048,"ALL",False,None),
    FundamentalStatementMapRow(SOURCE_NAME,"us-gaap","ClassDCommonStockSharesOutstanding","share_count","shares","class_d","Class D common shares outstanding","instant","credit","shares",1.0,10,False,True,"Class D common shares outstanding.",1049,"ALL",False,None),
