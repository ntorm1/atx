...
from db.xbrl_filing_contexts import XbrlFilingContextDataset, XbrlFilingContextOptions
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--user-agent", default="atx-impl XBRL filing context loader nathan.tormaschy@gmail.com")
