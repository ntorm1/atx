...
from db.xbrl_taxonomy import DEFAULT_XBRL_TAXONOMY_PACKAGE_URLS, XbrlTaxonomyOptions, refresh_xbrl_taxonomy
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--user-agent", default="atx-impl XBRL taxonomy loader nathan.tormaschy@gmail.com")
