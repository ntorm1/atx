...
from db import DEFAULT_DB_PATH, DuckDBStore, ThirteenFDataSet, ThirteenFOptions
from db.thirteenf import AAPL_CUSIP, normalize_cusip


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Load SEC Form 13F bulk data into the atx-impl DuckDB store.")
